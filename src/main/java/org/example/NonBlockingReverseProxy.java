 ...
 */
public class NonBlockingReverseProxy {
    ...
    public static void main(String[] args) throws Exception {
        ...
        config.setIoThreadCount(Integer.parseInt(prop.getProperty("ioThreadCount")));
        ...
        if (port == 8443) {
            ...
            URL url = cl.getResource("res/my.keystore");
            if (url == null) {
...
//                System.out.println("[client->proxy] " + this.httpExchange.getId() + " " + request.getRequestLine());
        ...
        public void consumeContent(
            ...
            synchronized (this.httpExchange) {
                ...
                /*To simulate slow reading client*/
                /*  try {
                 Thread.sleep(300);
...
//                System.out.println("[client<-proxy] " + this.httpExchange.getId() + " " + response.getStatusLine());
        ...
        public void produceContent(
            ...
            synchronized (this.httpExchange) {
                ...
                /*To simulate slow writing backend */
                /*try {
                 Thread.sleep(2000);
                 } catch (InterruptedException e) {
                 e.printStackTrace();
